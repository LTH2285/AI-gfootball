...
#   agent.critic.load_state_dict(saved_parameters_critic)
  ...
  while total_steps < args.max_train_steps:
    ...
    while not done:
      ...
      a, a_logprob = agent.choose_action(slist)  # Action and the corresponding log probability
    ...
    if episode % 100 == 0:
        # print("saving")
        torch.save(agent.actor.state_dict(), './gfootball/examples/actor_parameters.pth')
        torch.save(agent.critic.state_dict(), './gfootball/examples/critic_parameters.pth')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--mini_batch_size", type=int, default=501, help="Minibatch size")
    ...
    parser.add_argument("--epsilon", type=float, default=0.10, help="PPO clip parameter")
